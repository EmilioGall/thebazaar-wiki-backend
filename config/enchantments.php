...
return [
   ...
   // Angry Balloon Bot enchantments 
   [
      'deadly' => '+50% { Crit } Chance',
      'fiery' =>  "{ Burn } 6",
      'golden' => null,
   ...
   // Antimatter Chamber enchantments 
   [
      'deadly' => null,
      'fiery' =>  "{ Burn } 22",
      'golden' => null,
